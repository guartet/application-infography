...
import Trois_D.Cube;
import Trois_D.triangulaire;
import courbes.courbe;
import cylindre.cylindre;
...
public class menu_3 extends JFrame {
	...
	public menu_3() {
		...
		comboBox.addItem("Triangulaire");
		comboBox.addItem("cylindre");
		...
		btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					}else if(comboBox.getSelectedItem()=="Triangulaire"){
						 triangulaire V=new triangulaire();
						 V.setVisible(true);
						 V.setBounds(100, 100, 816, 606);
						 setVisible(false);
						// V.pack();
